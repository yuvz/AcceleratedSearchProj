...
def generate_example(warehouse, algorithm_name, routing_requests=[], is_show_animation=True, is_show_image=False,
                     is_export_visualization=False):
    plan, running_time, routing_requests = generate_rand_example(warehouse, algorithm_name, routing_requests)
