from DatabaseInterface import initialize_database_perliminary_files, generate_path_database, sample_path_database
...
HUGE_WAREHOUSE_IDS = [201, 202, 203, 204, 205]
...
def main():
    ...
    t0 = time()
    # plan = generate_path_database(warehouse, 10, [1.5])
    plan = sample_path_database(warehouse, 10, 15, 1.5)
    t1 = time()
